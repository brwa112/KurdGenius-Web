                                ...
                                <div class="panel">
                                    ...
                                    <div class="mb-5">
                                        <div class="border-b border-[#ebedf2] dark:border-[#1b2e4b]">
                                            <div class="flex items-start justify-between py-3">
                                                <div class="flex-none ltr:mr-4 rtl:ml-4">
                                                    <img src="/public/assets/images/card-americanexpress.svg" alt="" />
                                                </div>
                                                <h6 class="text-[#515365] font-bold dark:text-white-dark text-[15px]">
                                                    Mastercard
                                                    <span
                                        ...
                                        <div class="border-b border-[#ebedf2] dark:border-[#1b2e4b]">
                                            <div class="flex items-start justify-between py-3">
                                                <div class="flex-none ltr:mr-4 rtl:ml-4">
                                                    <img src="/public/assets/images/card-mastercard.svg" alt="" />
                                                </div>
                                                <h6 class="text-[#515365] font-bold dark:text-white-dark text-[15px]">
                                        ...
                                        <div>
                                            <div class="flex items-start justify-between py-3">
                                                <div class="flex-none ltr:mr-4 rtl:ml-4">
                                                    <img src="/public/assets/images/card-visa.svg" alt="" />
                                                </div>
                                                <h6 class="text-[#515365] font-bold dark:text-white-dark text-[15px]">
                                                    Visa<span
                                                        class="block text-white-dark dark:text-white-light font-normal b-text-xs mt-1">XXXX
                                        ...
                                        <label class="inline-flex cursor-pointer">
                                            ...
                                            <span>
                                                <img class="ms-3" width="100" height="68" alt="settings-dark"
                                                    src="/public/assets/images/settings-light.svg" />
                                            </span>
                                        </label>
                                        ...
                                        <label class="inline-flex cursor-pointer">
                                            ...
                                            <span>
                                                <img class="ms-3" width="100" height="68" alt="settings-light"
                                                    src="/public/assets/images/settings-dark.svg" />
                                            </span>
                                        </label>
                                    </div>
                                </div>
