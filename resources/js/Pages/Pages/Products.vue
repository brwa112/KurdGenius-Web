        ...
        <div class="pt-5">
            <div class="panel pb-0">
                ...
                <Datatable :rows="products" :columns="columns" :totalRows="products.data?.length" @change="apply_filter"
                    ...
                    <template v-if="$can('edit_products') || $can('delete_products') || $can('restore_products')"
                        #actions="data">
...
const callForceDelete = (row) => {
    Swal.fire({
        ...
        if (result.value) {
            form.delete(route('control.pages.products.force_delete', row.id), {
...
const callRestore = (row) => {
    Swal.fire({
        ...
        if (result.value) {
            form.post(route('control.pages.products.restore', row.id), {
