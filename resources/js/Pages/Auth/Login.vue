                ...
                <div
                    ...
                    <div
                        ...
                        <div class="dropdown ms-auto w-max">
                            <Popper :placement="dir === 'rtl' ? 'bottom-start' : 'bottom-end'" offsetDistance="8">
                                <button type="button"
                                    class="flex items-center gap-2.5 rounded-lg border border-white-dark/30 bg-white px-2 py-1.5 text-white-dark hover:border-primary hover:text-primary dark:bg-black">
                                    <div>
                                        <img :src="`/assets/images/flags/${currentLang.code.toUpperCase()}.svg`"
                                            alt="image" class="h-5 w-5 rounded-full object-cover" />
                                    </div>
                                    <div class="text-base font-bold uppercase">{{ lang }}</div>
                                    <span class="shrink-0">
                                        <icon-caret-down />
                                    </span>
                                </button>
                                        ...
                                        <template v-for="item in languages" :key="item.code">
                                            <li>
                                                <button type="button" class="w-full hover:text-primary"
                                                    :class="{ 'bg-primary/10 text-primary': currentLang.code === item.code }"
                                                    @click="toggleDirection('ltr', item), close()">
