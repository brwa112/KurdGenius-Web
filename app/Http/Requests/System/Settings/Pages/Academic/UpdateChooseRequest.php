...
class UpdateChooseRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'reasons.en' => 'required|array|min:1|max:10',
            ...
            'reasons.ckb' => 'required|array|min:1|max:10',
            ...
            'reasons.ar' => 'nullable|array|max:10',
            'reasons.ar.*' => 'nullable|array',
            'reasons.ar.*.title' => 'nullable|string',
            'reasons.ar.*.description' => 'nullable|string',
            'reasons.ar.*.icon' => 'nullable|string',
            'reasons.ar.*.bgColor' => 'nullable|string',
            'reasons.ar.*.borderColor' => 'nullable|string',
    ...
    public function attributes(): array
    {
        return [
            ...
            'reasons.ar' => __('system.reasons') . ' (' . __('system.ar') . ')',
            'reasons.ar.*' => __('system.reason') . ' (' . __('system.ar') . ')',
            'reasons.ar.*.title' => __('system.title') . ' (' . __('system.ar') . ')',
            'reasons.ar.*.description' => __('system.description') . ' (' . __('system.ar') . ')',
        ];
    }
}
